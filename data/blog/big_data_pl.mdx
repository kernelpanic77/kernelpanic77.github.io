...
# Big Data Systems and Programming Languages:

A Study

# Group 14Ishan Shanware
...
![](img/Programming%20Languages%20Project%2020220.png)

The definition of big data is data that contains greater variety\, arriving in increasing volumes and with more velocity\. Variety\, Volume\, Velocity is also known as the three Vs\.

It is used in [machine learning](https://www.techtarget.com/searchenterpriseai/definition/machine-learning-ML) projects\, [predictive modeling](https://www.techtarget.com/searchenterpriseai/definition/predictive-modeling) and other advanced analytics applications\.
...
<span style="color:#232F3E">
  Data collection consists of messaging systems which are essential in sending
  the data from a source to a destination based on the publish/subscribe
  paradigm\. These message brokerage systems\, supply streams of data to stream
  processing frameworks\.{" "}
</span>

<span style="color:#232F3E">
  Stream processing is the practice of taking action on a series of data at the
  time the data is created\. Stream processing is closely related to real time
  analytics\, complex event processing\, and streaming analytics\.
...
<span style="color:#232F3E">
  It consists of two main parts\, data storage and data retrieval\.Distributed
  file systems handles the responsibility of large scale data storage\. Data
  retrieval is handled by NoSQL databases\.{" "}
</span>

<span style="color:#232F3E">T</span> <span style="color:#232F3E">
  he final stage of processing the big data is Data Analysis\.{" "}
</span>
...
![](img/Programming%20Languages%20Project%2020221.png)

![](img/Programming%20Languages%20Project%2020222.png)

![](img/Programming%20Languages%20Project%2020223.png)

![](img/Programming%20Languages%20Project%2020224.png)

![](img/Programming%20Languages%20Project%2020225.png)

![](img/Programming%20Languages%20Project%2020226.png)

![](img/Programming%20Languages%20Project%2020227.png)

# Distributed Computing in Big Data Systems
...
![](img/Programming%20Languages%20Project%2020228.png)

![](img/Programming%20Languages%20Project%2020229.png)

# Programming Languages for Distributed Systems

Communication and Synchronization between parallel parts of the program

Exception Handling mechanism brought about by partial failure
...
![](img/Programming%20Languages%20Project%20202210.png)

![](img/Programming%20Languages%20Project%20202211.png)

![](img/Programming%20Languages%20Project%20202212.png)

# Functional programming in Distributed Systems

![](img/Programming%20Languages%20Project%20202213.png)

# Concurrency in Distributed Systems:

Applications and Services can offer resources that can be shared by clients
Many clients will access shared resource at the same time
concurrency is a pretty complex subject. Threads and locks, avoiding issues like race conditions and deadlocks make concurrent programs difficult to right.
Problem with OOPs approach:
Mutable State: Object’s method is supposed to mutate it’s internal state
Mutex lock introduces the problem deadlocks
To solve the problem, Object oriented code become extremely lengthy
Functional Programming approach:
Purity: Avoids side-effects
Immutability
Functional languages have data types that don’t mutate.
...
![](img/Programming%20Languages%20Project%20202214.png)

<span style="color:#4DD0E1">public</span>  <span style="color:#ECEFF1"> </span>  <span style="color:#4DD0E1">void</span>  <span style="color:#ECEFF1"> greetingsFromSanta\(</span>  <span style="color:#4DD0E1">int</span>  <span style="color:#ECEFF1"> n\) \{</span>

<span style="color:#ECEFF1"> </span> <span style="color:#4DD0E1">int</span> <span style="color:#ECEFF1">
  {" "}
  i ={" "}
</span> <span style="color:#FBC02D">0</span> <span style="color:#ECEFF1">
  ;
</span>

<span style="color:#ECEFF1">    </span>  <span style="color:#4DD0E1">while</span>  <span style="color:#ECEFF1"> \(i < n\) \{</span>

<span style="color:#ECEFF1"> </span> <span style="color:#CE93D8">System</span> <span style="color:#ECEFF1">
  \.out\.print\(
</span> <span style="color:#9CCC65">"Ho\! "</span> <span style="color:#ECEFF1">
  \);
</span>

<span style="color:#ECEFF1"> i = i \+ </span> <span style="color:#FBC02D">
  1
</span> <span style="color:#ECEFF1">;</span>

<span style="color:#ECEFF1"> \}</span>

<span style="color:#ECEFF1">\}</span>

<span style="color:#ECEFF1">\(</span> <span style="color:#4DD0E1">defn</span> <span style="color:#ECEFF1">
  {" "}
  greetings\-from\-santa \[n\]
</span>

<span style="color:#ECEFF1"> \(</span> <span style="color:#4DD0E1">if</span> <span style="color:#ECEFF1">
  {" "}
  \(
</span> <span style="color:#4DD0E1">></span> <span style="color:#ECEFF1">
  {" "}
  n{" "}
</span> <span style="color:#FBC02D">0</span> <span style="color:#ECEFF1">
  \)
...
<span style="color:#ECEFF1"> \(</span> <span style="color:#4DD0E1">do</span>

<span style="color:#ECEFF1"> \(</span> <span style="color:#4DD0E1">print</span> <span style="color:#ECEFF1">
  {" "}
</span> <span style="color:#9CCC65">"Ho\! "</span> <span style="color:#ECEFF1">
  \)
</span>

<span style="color:#ECEFF1"> \(greetings\-from\-santa \(</span> <span style="color:#4DD0E1">
  dec
</span> <span style="color:#ECEFF1"> n\)\)\)\)\)</span>

# Data Stream Processing Frameworks and Message Brokerage Systems

![](img/Programming%20Languages%20Project%20202215.png)
...
![](img/Programming%20Languages%20Project%20202216.png)

# Data Storage and Management

![](img/Programming%20Languages%20Project%20202217.png)
...
![](img/Programming%20Languages%20Project%20202218.png)

An example of how the mapreduce functions work\.

# Compute Frameworks

![](img/Programming%20Languages%20Project%20202219.png)
...
![](img/Programming%20Languages%20Project%20202220.png)
...
![](img/Programming%20Languages%20Project%20202221.png)

# Compute Frameworks

![](img/Programming%20Languages%20Project%20202222.png)
...
![](img/Programming%20Languages%20Project%20202223.png)

![](img/Programming%20Languages%20Project%20202224.png)

![](img/Programming%20Languages%20Project%20202225.png)
...
However, high object churn and large heap sizes put severe strain on the garbage collector. As a result, applications underperform significantly: GC increases the runtime of typical data processing tasks by up to 40%.
...
![](img/Programming%20Languages%20Project%20202226.png)
...
![](img/Programming%20Languages%20Project%20202227.png)
...
# As compared to Python and R, Julia is a relatively new language. Python was not necessarily designed with parallel computing in mind. Parallel computing is becoming more and more important and more and more widely-used every single day especially for big data systems. Julia is built for scalability and speed of operations when handling large data sets.
...
Multi-threading,
and multi-core or distributed processing.
...
![](img/Programming%20Languages%20Project%20202228.png)

# Case Study: Programming Languages in
...
![](img/Programming%20Languages%20Project%20202229.png)
...
- Performance
  - Expectations: Higher Throughput and Better CPU Usage
  - Scala performs better than ruby in throughput and hardware utilization\.

![](img/Programming%20Languages%20Project%20202230.png)
...
<span style="color:#4DD0E1">def</span> <span style="color:#ECEFF1">
  {" "}
  isRateLimited\(user:{" "}
</span> <span style="color:#CE93D8">Long</span> <span style="color:#ECEFF1">
  \): Future\[
</span> <span style="color:#CE93D8">Boolean</span> <span style="color:#ECEFF1">
  \] = \.\.\.
</span>
...
<span style="color:#4DD0E1">def</span> <span style="color:#ECEFF1">
  ...
  \, tweet:{" "}
</span> <span style="color:#CE93D8">String</span> <span style="color:#ECEFF1">
  \): Future\[
</span> <span style="color:#CE93D8">Unit</span> <span style="color:#ECEFF1">
  \] = \.\.\.
</span>

<span style="color:#4DD0E1">val</span> <span style="color:#ECEFF1">
  {" "}
  user ={" "}
</span> <span style="color:#FBC02D">12L</span>
...
<span style="color:#4DD0E1">val</span> <span style="color:#ECEFF1">
  ...
  {" "}
  ={" "}
</span> <span style="color:#9CCC65">"just setting up my twitter"</span>
...
<span style="color:#ECEFF1">  isRateLimited\(user\)\.flatMap \{</span>

<span style="color:#ECEFF1"> </span> <span style="color:#4DD0E1">case</span> <span style="color:#ECEFF1">
  {" "}
</span> <span style="color:#4DD0E1">true</span> <span style="color:#ECEFF1">
  {" "}
</span> <span style="color:#4DD0E1">=></span> <span style="color:#ECEFF1">
  {" "}
  Future\.exception\(
</span> <span style="color:#4DD0E1">new </span> <span style="color:#ECEFF1">
  RateLimitingError\)
</span>

<span style="color:#ECEFF1"> </span> <span style="color:#4DD0E1">case</span> <span style="color:#ECEFF1">
  {" "}
</span> <span style="color:#4DD0E1">false</span> <span style="color:#ECEFF1">
  {" "}
</span> <span style="color:#4DD0E1">=></span> <span style="color:#ECEFF1">
  {" "}
  writeTweet\(user\, tweet\)
</span>
...
<span style="color:#4DD0E1">val</span> <span style="color:#ECEFF1">
  {" "}
  count: Future\[
</span> <span style="color:#CE93D8">Int</span> <span style="color:#ECEFF1">
  \] = getCount\(\)
</span>

<span style="color:#ECEFF1">count\.respond \{</span>

<span style="color:#ECEFF1"> </span> <span style="color:#4DD0E1">case</span> <span style="color:#ECEFF1">
  {" "}
  Return\(value\){" "}
</span> <span style="color:#4DD0E1">=></span>

<span style="color:#ECEFF1"> println\(s</span> <span style="color:#9CCC65">
  "The count was{" "}
</span> <span style="color:#ECEFF1">$value</span> <span style="color:#9CCC65">
  "
</span> <span style="color:#ECEFF1">\)</span>
...
<span style="color:#ECEFF1"> println\(s</span> <span style="color:#9CCC65">
  "getCount failed with{" "}
</span> <span style="color:#ECEFF1">$exc</span> <span style="color:#9CCC65">
  "
</span> <span style="color:#ECEFF1">\)</span>
...
![](img/Programming%20Languages%20Project%20202231.png)
...
![](img/Programming%20Languages%20Project%20202232.png)
...
![](img/Programming%20Languages%20Project%20202233.png)

# References

Holden Karau\. Rachel Warren\. High Performance Spark\. Oreilly\.
...
Rao _et al_ \. The big data system\, components\, tools and technologies: a survey
